                    ...
                    <div class="video-wrapper">
                        <div class="react-player">
                            <div class="react-view">
                                <iframe src="{{ $defaultLesson->video_url }}" frameborder="0" allowfullscreen
                                    style="width: 1000px; height: 670px; padding-top: 50px"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <ul>
                                            <li>
                                                ...
                                                <span><a href="{{ route('video', [$lesson->id]) }}">{{ $lesson->title }}</a></span>
