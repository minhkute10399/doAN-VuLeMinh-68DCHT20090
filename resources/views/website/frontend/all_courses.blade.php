    ...
    <div class="container">
        <div class="classy-nav-container breakpoint-off">
            ...
            <nav class="classy-navbar justify-content-between" id="EduStudyNav">
                ...
                <!-- Logo -->
                <a class="nav-brand" href="index-three.html"><img src="{{ asset('edufield/assets/img/logo.png') }}" alt="logo"></a>
                   ...
                   @foreach ($courses as $course)
                        <div class="courses-item">
                            <div class="courses-img">
                                <img src="{{ asset(config('image_path.images') .'/'. $course->images) }}" alt="course">
                            </div>

                            <div class="courses-content">
                                <h3><a href="{{ route('singleCourse', $course->id) }}">{{ $course->name }}</a></h3>
                                <p class="description_course">{{ $course->description }}</p>
                            </div>

                            <div class="courses-content-bottom">
                                <h4 class="price">Free</h4>
                                <h4><a href="{{ route('singleCourse', $course->id) }}" class="btn btn-primary">Read More</a></h4>
                            </div>
                        </div>
                   @endforeach
                </div>
